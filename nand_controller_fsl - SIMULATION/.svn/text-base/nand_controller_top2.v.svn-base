/*******************************************************************************
*
*  File Name:  nand_controller_top.v
*  Dependencies:  
*
*  Email:   mseok@andrew.cmu.edu
*
*  Description:  NAND Controller for Micron MT29F16G08DAAWP
*
*  Note: Designed with a 100MHz clock in mind.
*
*  Limitation:
*
*  Supported Commands:
*     Read Status, Reset, Read Page*, Program Page, Block Erase*, Read For Internal Data Move*, Program for Internal Data Move*
      *not implemented yet
*
********************************************************************************/
`timescale 1ns / 1ns

module nand_controller_top ( DONE, DATA_DONE, DATA_READY, RB, status, DATA_OUT, DATA_IN, ADDR, CMD, DATA_LOADED, CMD_LOADED,LEN, clk, reset,
