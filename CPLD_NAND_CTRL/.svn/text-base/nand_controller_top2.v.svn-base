...
module nand_controller_top ( DONE, DATA_DONE, DATA_READY, RB, status, DATA_OUT, current_fsm_state, DATA_IN, ADDR, CMD, DATA_LOADED, CMD_LOADED,LEN, clk, reset,
   ce1_l,ce2_l,ale,cle,re_l,we_l,/*io_I,io_O,io_T*/io,rb1_l,rb2_l );
   output DONE;
   output DATA_DONE;
   output DATA_READY;
   ...
   assign io = io_T?8'hzz:io_O;   //io_T = 0:out, 1:in
   assign io_I = io;
   input rb1_l, rb2_l;
   ...
   /*FSM Stuff*/
   reg [6:0] fsm_laststate, fsm_currstate, fsm_nextstate;
   //reg [31:0] fsm_timer, fsm_timer_setval;
   reg [16:0] fsm_timer, fsm_timer_setval; 
   reg fsm_timer_set;
