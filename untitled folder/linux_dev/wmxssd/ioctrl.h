...
#define RX_CNT_OFFSET			0x28			// RX COUNT OFFSET
#define TX_CNT_OFFSET			0x2C			// TX COUNT OFFSET
...
#define DEBUG_OFFSET			0x48
#define ATOMIC_WRITE_OFFSET		0x4C
#define ATOMIC_READ_OFFSET		0x50
