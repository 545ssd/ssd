...
# Project:F:\ssd_repo\NAND_CTRL_FPGA-DIMM\system.xmp
#
...
XILINX_EDK_DIR = /cygdrive/f/Xilinx/EDK
NON_CYG_XILINX_EDK_DIR = F:/Xilinx/EDK
...
SEARCHPATHOPT =  -lp C:/EDK-XUPV5-LX110T-Pack/lib/
...
TESTAPP_NAND_OUTPUT_DIR = TestApp_Nand
TESTAPP_NAND_OUTPUT = $(TESTAPP_NAND_OUTPUT_DIR)/executable.elf
...
BRAMINIT_ELF_FILES =  $(TESTAPP_NAND_OUTPUT) 
BRAMINIT_ELF_FILE_ARGS =   -pe microblaze_0 $(TESTAPP_NAND_OUTPUT) 

ALL_USER_ELF_FILES = $(TESTAPP_MEMORY_MICROBLAZE_0_OUTPUT) $(TESTAPP_PERIPHERAL_MICROBLAZE_0_OUTPUT) $(TESTAPP_NAND_OUTPUT) 
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -sd implementation/ -s mti -X F:/ssd_repo/NAND_CTRL_FPGA-DIMM/
...
PROGRAMCLEAN_TARGETS = TestApp_Memory_microblaze_0_programclean TestApp_Peripheral_microblaze_0_programclean TestApp_Nand_programclean 
...
implementation/nand_01_0_wrapper.ngc \
implementation/nand_plb_to_mb_0_wrapper.ngc
...
TESTAPP_MEMORY_MICROBLAZE_0_SOURCES = /cygdrive/f/ssd_repo/NAND_CTRL_FPGA-DIMM/TestApp_Memory_microblaze_0/src/TestApp_Memory.c 
...
TESTAPP_MEMORY_MICROBLAZE_0_LINKER_SCRIPT = /cygdrive/f/ssd_repo/NAND_CTRL_FPGA-DIMM/TestApp_Memory_microblaze_0/src/TestApp_Memory_LinkScr.ld
...
TESTAPP_MEMORY_MICROBLAZE_0_CC_INFERRED_FLAGS= -mno-xl-soft-mul -mxl-pattern-compare -mcpu=v7.20.d 
...
TESTAPP_PERIPHERAL_MICROBLAZE_0_SOURCES = /cygdrive/f/ssd_repo/NAND_CTRL_FPGA-DIMM/TestApp_Peripheral_microblaze_0/src/TestApp_Peripheral.c /cygdrive/f/ssd_repo/NAND_CTRL_FPGA-DIMM/TestApp_Peripheral_microblaze_0/src/xuartlite_selftest_example.c 

TESTAPP_PERIPHERAL_MICROBLAZE_0_HEADERS = /cygdrive/f//ssd_repo/NAND_CTRL_FPGA-DIMM/TestApp_Peripheral_microblaze_0/src/uartlite_header.h 
...
TESTAPP_PERIPHERAL_MICROBLAZE_0_LINKER_SCRIPT = /cygdrive/f/ssd_repo/NAND_CTRL_FPGA-DIMM/TestApp_Peripheral_microblaze_0/src/TestApp_Peripheral_LinkScr.ld
...
TESTAPP_PERIPHERAL_MICROBLAZE_0_CC_INFERRED_FLAGS= -mno-xl-soft-mul -mxl-pattern-compare -mcpu=v7.20.d 
...
#################################################################
# SOFTWARE APPLICATION TESTAPP_NAND
#################################################################

TESTAPP_NAND_SOURCES = /cygdrive/f/ssd_repo/NAND_CTRL_FPGA-DIMM/TestApp_Nand/src/nand.c 

TESTAPP_NAND_HEADERS = 

TESTAPP_NAND_CC = mb-gcc
TESTAPP_NAND_CC_SIZE = mb-size
TESTAPP_NAND_CC_OPT = -O2
TESTAPP_NAND_CFLAGS = 
TESTAPP_NAND_CC_SEARCH = # -B
TESTAPP_NAND_LIBPATH = -L./microblaze_0/lib/ # -L
TESTAPP_NAND_INCLUDES = -I./microblaze_0/include/ # -I
TESTAPP_NAND_LFLAGS = # -l
TESTAPP_NAND_LINKER_SCRIPT = 
TESTAPP_NAND_LINKER_SCRIPT_FLAG = #-Wl,-T -Wl,$(TESTAPP_NAND_LINKER_SCRIPT) 
TESTAPP_NAND_CC_DEBUG_FLAG =  -g 
TESTAPP_NAND_CC_PROFILE_FLAG = # -pg
TESTAPP_NAND_CC_GLOBPTR_FLAG= # -mxl-gp-opt
TESTAPP_NAND_MODE = executable
TESTAPP_NAND_LIBG_OPT = -$(TESTAPP_NAND_MODE) microblaze_0
TESTAPP_NAND_CC_INFERRED_FLAGS= -mno-xl-soft-mul -mxl-pattern-compare -mcpu=v7.20.d 
TESTAPP_NAND_CC_START_ADDR_FLAG=  # -Wl,-defsym -Wl,_TEXT_START_ADDR=
TESTAPP_NAND_CC_STACK_SIZE_FLAG=  # -Wl,-defsym -Wl,_STACK_SIZE=
TESTAPP_NAND_CC_HEAP_SIZE_FLAG=  # -Wl,-defsym -Wl,_HEAP_SIZE=
TESTAPP_NAND_OTHER_CC_FLAGS= $(TESTAPP_NAND_CC_GLOBPTR_FLAG)  \
                  $(TESTAPP_NAND_CC_START_ADDR_FLAG) $(TESTAPP_NAND_CC_STACK_SIZE_FLAG) $(TESTAPP_NAND_CC_HEAP_SIZE_FLAG)  \
                  $(TESTAPP_NAND_CC_INFERRED_FLAGS)  \
                  $(TESTAPP_NAND_LINKER_SCRIPT_FLAG) $(TESTAPP_NAND_CC_DEBUG_FLAG) $(TESTAPP_NAND_CC_PROFILE_FLAG) 
