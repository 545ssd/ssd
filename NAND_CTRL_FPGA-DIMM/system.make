...
# F:\ssd_repo\NAND_CTRL_FPGA-DIMM\system.mhs
# The software specification of the system is in file :
# F:\ssd_repo\NAND_CTRL_FPGA-DIMM\system.mss
...
TestApp_Nand_program: $(TESTAPP_NAND_OUTPUT) 

$(TESTAPP_NAND_OUTPUT) : $(TESTAPP_NAND_SOURCES) $(TESTAPP_NAND_HEADERS) $(TESTAPP_NAND_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/testapp_nand_compiler.opt
	@mkdir -p $(TESTAPP_NAND_OUTPUT_DIR) 
	$(TESTAPP_NAND_CC) $(TESTAPP_NAND_CC_OPT) $(TESTAPP_NAND_SOURCES) -o $(TESTAPP_NAND_OUTPUT) \
	$(TESTAPP_NAND_OTHER_CC_FLAGS) $(TESTAPP_NAND_INCLUDES) $(TESTAPP_NAND_LIBPATH) \
	$(TESTAPP_NAND_CFLAGS) $(TESTAPP_NAND_LFLAGS) 
	$(TESTAPP_NAND_CC_SIZE) $(TESTAPP_NAND_OUTPUT) 
	@echo ""

TestApp_Nand_programclean:
	rm -f $(TESTAPP_NAND_OUTPUT) 
